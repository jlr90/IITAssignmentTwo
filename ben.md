...
When comparing Group7’s Ideal Jobs to the Burning Glass data for the Top 25 IT Job Titles, Group7 member’s employability appears unideal at a glance. Two of the desired positions (Senior UX/UI Designer and Senior Systems Architect) are not present on the  list at all, and the remaining ideal jobs from the team are quite away from the top of the list.  To get a better understanding of what this really means, we need to examine these findings from a few different angles, and in regard to comparisons with other BG data lists. 

The lack of demand for a specific job title should not necessarily be mistaken for a lack of employability for those seeking work with the skills required for their Ideal Job. A Full Stack Developer may not be a highly demanded job title according to the BG data, but the skills required to be a Full Stack Developer would allow the job seeker to be desirable for a range of highly demanded job titles. These could include a .Net Developer (Rank #23), Front End Developer (#19), Java Developer (#18).[InTextRef about full stack developers, for java, front end dev, .net].

Similarly, the position of a Senior UX/UI Designer as a job title is not listed in the BG data, but requires the skills of multiple job titles that are. These include the skills of a Front End Developer (#19), Graphic Designer (#24) and Ux Designer (#5). [InTextRef for Senior UX/UI Designer skills requirement].  

One of the career paths that lead to becoming a Senior Systems Architect is to first have strong experience as a Solutions Architect which ranks at the top of the list at #25. [InTextRef for Solutions Architect] Therefore, even though Senior Systems Architect is not listed in the Top 25 In-Demand Job Titles BG data, the skills required to be one suggest a competitive employment advantage in related positions.

Senior positions and niche positions will often be in less demand, but that should not infer their unimportance as a position[InTextRef about Senior Positions being fewer].
...
A ‘Software Developer’ as a job title is amongst the least desired (#7), but a 'Software Developer' as an occupation is the most desired (#25). To add to the ambiguity of the comparison, ‘Computer Programmer’ on the BG Top 25 Occupations list ranks at #8, quite a way from the top ranking ‘Software Developer’ occupation, despite the terms being synonymous. 
...
Comparison: Group7’s Required Skill Set vs Demand For Specialist IT Skills:

The skills required to fulfill the Ideal Jobs of Group7 members were collated. Below is a graph showing the comparison of how many of our group members required each of the Top25 Skills as listed on the BG Top IT Skills list.

IMG: "Specialist IT Skills - Chart.png"

There is a diverse range of job interest within our group, and as such, it’s not common to find a skill on the BG IT Skills lists that is not covered by at least one Group7 Member.
...
Comparison: Group7’s Required Skill Set vs Demand For Baseline Skills:

Below is a graph showing how many of the Group7 Ideal Jobs require the skills listed in the BG data for the Demand of Baseline Skills. Similarly to the comparison between Group7 Required Skill Set and the Demand for Specialist IT Skills, due to the variety of Ideal Job interests from Group7, every skill in the BG data for the Demand for Baseline Skills has been covered by a Group7 member. 

IMG: "Baseline Skills - Chart.png"
